...
<template>
  ...
  <!-- 整个聊天内容区域 -->
  <div style="background: #d21818;" id="chat-body">
    <!-- 对方聊天消息条 -->
    <div style="padding-right: -20px">
      <van-space
        direction="vertical"
        fill
        style="padding: 5px 2px; margin: 10px 15px"
        v-for="i in 3"
        :key="i"
      >
        <van-row gutter="1">
    ...
    <div style="padding-left: 55px">
      <van-space
        direction="vertical"
        fill
        style="padding: 5px 2px; margin-right: -15px; margin-top: 15px; margin-bottom: 15px"
        v-for="i in 2"
        :key="i"
      >
        <van-row gutter="1">
  ...
  <!-- 下方输入框区域 -->
  <van-space direction="vertical" fill style="padding: 5px 2px; margin: 15px">
    <van-row gutter="10" style="background: #ffffffff">
      <van-col sapn="1">
